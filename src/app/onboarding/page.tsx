...
export default function Onboarding() {
    ...
    switch (currentStep) {
        ...
        return (
          <div className="space-y-8">
            <div className="text-center">
              <div className="w-20 h-20 bg-indigo-100 dark:bg-indigo-950/50 rounded-full flex items-center justify-center mx-auto mb-6">
                <Building2 className="w-10 h-10 text-indigo-600 dark:text-indigo-500" />
              </div>
              <h2 className="text-3xl font-bold mb-4 dark:text-gray-100">Where do you work?</h2>
              <p className="text-lg text-gray-600 dark:text-gray-400">This helps us tailor your experience</p>
            </div>
                ...
                return (
                  <button
                    ...
                    className={`p-6 rounded-2xl border-2 transition-all text-left ${
                      isSelected
                        ? 'border-indigo-500 bg-indigo-50 dark:bg-indigo-950/30 shadow-lg scale-105'
                  ...
                  >
                    ...
                    <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">{env.label}</h3>
      ...
      case 1:
        return (
          <div className="space-y-8">
            <div className="text-center">
              <div className="w-20 h-20 bg-blue-100 dark:bg-blue-950/50 rounded-full flex items-center justify-center mx-auto mb-6">
                <Clock className="w-10 h-10 text-blue-600 dark:text-blue-500" />
              </div>
              <h2 className="text-3xl font-bold mb-4 dark:text-gray-100">How long do you sit daily?</h2>
              <p className="text-lg text-gray-600 dark:text-gray-400">Be honest - this helps us set realistic goals</p>
            </div>

            <div className="max-w-md mx-auto space-y-6">
              <div className="text-center">
                <div className="text-6xl font-bold text-indigo-600 dark:text-indigo-500 mb-4">
                ...
                />
                <div className="flex justify-between text-sm text-gray-500 dark:text-gray-400 mt-4 max-w-xs mx-auto">
                  <span>2h</span>
                  <span>8h</span>
                  <span>14h</span>
                </div>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 p-6 rounded-2xl border border-blue-100 dark:border-blue-900">
                <div className="flex items-start space-x-3">
                  <Sparkles className="w-5 h-5 text-blue-600 dark:text-blue-500 mt-0.5" />
                  <div>
      ...
      case 2:
        return (
          <div className="space-y-8">
            <div className="text-center">
              <div className="w-20 h-20 bg-purple-100 dark:bg-purple-950/50 rounded-full flex items-center justify-center mx-auto mb-6">
                <Heart className="w-10 h-10 text-purple-600 dark:text-purple-500" />
              </div>
              <h2 className="text-3xl font-bold mb-4 dark:text-gray-100">Any pain or discomfort?</h2>
              <p className="text-lg text-gray-600 dark:text-gray-400">Select all that apply (optional)</p>
            </div>
            ...
            <div className="max-w-2xl mx-auto">
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {painOptions.map((pain) => (
                  ...
                  >
                    ...
                    <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{pain.label}</p>
                    {onboardingData.painAreas.includes(pain.id) && (
                      <Check className="w-4 h-4 text-purple-600 dark:text-purple-400 mx-auto mt-2" />
                    )}
                  </button>
                ))}
              </div>
              ...
              {onboardingData.painAreas.length > 0 && (
                <div className="mt-6 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-950/30 dark:to-pink-950/30 p-6 rounded-2xl border border-purple-100 dark:border-purple-900">
                  <div className="flex items-start space-x-3">
                    <Target className="w-5 h-5 text-purple-600 dark:text-purple-500 mt-0.5" />
                    <div>
          ...
          <div className="space-y-8">
            <div className="text-center">
              <div className="w-20 h-20 bg-green-100 dark:bg-green-950/50 rounded-full flex items-center justify-center mx-auto mb-6">
                <Calendar className="w-10 h-10 text-green-600 dark:text-green-500" />
              </div>
              <h2 className="text-3xl font-bold mb-4 dark:text-gray-100">Your work schedule</h2>
              <p className="text-lg text-gray-600 dark:text-gray-400">This helps us time your reminders perfectly</p>
            </div>

            <div className="max-w-md mx-auto space-y-6">
              <div className="space-y-4">
                <Label className="text-lg font-medium dark:text-gray-200">Work Hours</Label>
              ...
              <div className="space-y-4">
                <Label className="text-lg font-medium dark:text-gray-200">Work Days</Label>
              ...
              <div className="space-y-4">
                <Label className="text-lg font-medium dark:text-gray-200">Break Frequency</Label>
                <RadioGroup
                ...
                >
                  {[
                    ...
                    <div key={option.value} className="flex items-center space-x-3 p-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800">
                      <RadioGroupItem value={option.value} id={option.value} />
                      <div className="flex-1">
                        <Label htmlFor={option.value} className="font-medium dark:text-gray-200">{option.label}</Label>
      ...
      case 5:
        return (
          <div className="space-y-8">
            <div className="text-center">
              <div className="w-20 h-20 bg-indigo-100 dark:bg-indigo-950/50 rounded-full flex items-center justify-center mx-auto mb-6">
                <User className="w-10 h-10 text-indigo-600 dark:text-indigo-500" />
              </div>
              <h2 className="text-3xl font-bold mb-4 dark:text-gray-100">Create your account</h2>
              <p className="text-lg text-gray-600 dark:text-gray-400">Let's set up your profile</p>
            </div>

            <div className="max-w-md mx-auto space-y-6">
              <div className="space-y-4">
                <Label className="text-lg font-medium dark:text-gray-200">Your Name</Label>
                <Input
                  type="text"
              ...
              <div className="space-y-4">
                <Label className="text-lg font-medium dark:text-gray-200">Email Address</Label>
                <Input
                  type="email"
              ...
              <div className="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-950/30 dark:to-purple-950/30 p-6 rounded-2xl border border-indigo-100 dark:border-indigo-900">
                ...
                <div className="space-y-2 text-sm text-indigo-700 dark:text-indigo-400">
                  <div className="flex items-center">
                    <div className="w-2 h-2 bg-indigo-400 dark:bg-indigo-500 rounded-full mr-2"></div>
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-6">
              <div className="w-20 h-20 bg-indigo-100 dark:bg-indigo-950/50 rounded-full flex items-center justify-center mx-auto mb-6">
                <Camera className="w-10 h-10 text-indigo-600 dark:text-indigo-500" />
              </div>
              <h2 className="text-3xl font-bold mb-4 dark:text-gray-100">Calibrate Your Posture</h2>
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-6">
              ...
              <h2 className="text-3xl font-bold mb-4 dark:text-gray-100">Connect Your Mobile App</h2>
              <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                Sync your posture data with our mobile app to get personalized exercise recommendations
              </p>
            </div>

            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 p-6 rounded-2xl border border-indigo-100 dark:border-indigo-900 max-w-2xl mx-auto mb-6">
            ...
            {userId ? (
              ...
              <div className="text-center p-8 bg-yellow-50 dark:bg-yellow-950/30 rounded-lg border border-yellow-200 dark:border-yellow-900">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-amber-50 to-orange-50 dark:from-gray-950 dark:via-gray-900 dark:to-orange-950/30">
      {/* Header */}
      <header className="bg-white/80 dark:bg-gray-900/80 backdrop-blur border-b border-orange-100 dark:border-gray-800">
      ...
      {/* Progress Bar */}
      <div className="bg-white/60 dark:bg-gray-900/60 backdrop-blur border-b border-orange-100 dark:border-gray-800">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <Card className="bg-white/90 dark:bg-gray-900/90 backdrop-blur border-0 shadow-xl">
